(function() {
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this._container.innerHTML = "", b = a = 0, a = this._options.width ? this.width : 0 < this._container.clientWidth ? this._container.clientWidth : this.width, b = this._options.height ? this.height : 0 < this._container.clientHeight ?
            this._container.clientHeight : this.height, this.width = a, this.height = b, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this._selectedColorSet = "undefined" !== typeof W[this.colorSet] ? W[this.colorSet] : W.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class", "canvasjs-chart-container"), this._canvasJSContainer.style.position = "relative", this._canvasJSContainer.style.textAlign = "left", this._canvasJSContainer.style.cursor = "auto", t || (this._canvasJSContainer.style.height =
                ...
                this._canvasJSContainer.appendChild(this._toolBar), this.bounds = {
                    ...
                    "canvasjs-chart-credit"), this._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:3px;top:" + (this.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:0px;font-family:Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"), this._creditLink.setAttribute("tabIndex", -1), this._creditLink.setAttribute("target", "_blank")), this._toolTip = new R(this, this._options.toolTip, this.theme), this.axisY2 = this.axisY = this.axisX = this.data = null, this.sessionVariables = {
                    axisX: {},
                    axisY: {},
                    axisY2: {}
    ...
    var t = !!document.createElement("canvas").getContext,
        ma = {
            ...
            Axis: {
                ...
                titleFontSize: 20,
                titleFontFamily: "FranklinGothic-Book",
                titleFontWeight: "normal",
                titleFontStyle: "normal",
                labelAngle: 0,
                labelFontFamily: "FranklinGothic-Book",
            ...
            DataSeries: {
                ...
                indexLabelFontFamily: "FranklinGothic-Book",
        ...
        W = {
            colorSet1: "#92D050 #C00000 #C00000 #7F7F7F #FFC000 #DAE3F3 #7F6084 #77A033 #33558B #E59566".split(" "),
            colorSet2: "#c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000 #c00000".split(" "),
        ...
        Y = {
            theme1: {
                ...
                Title: {
                    fontFamily: t ? "FranklinGothic-Book, Optima, Candara, Verdana, Geneva, sans-serif" : "FranklinGothic-Book",
                    fontSize: 33,
                    fontColor: "#3A3A3A",
                    fontWeight: "bold",
                    verticalAlign: "top",
    ...
    u.prototype._updateOptions =
        function() {
            ...
            if (!this._dropdownMenu && this.exportEnabled &&
                ...
                this._dropdownMenu.style.cssText = "position: absolute; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 1px;top: 25px;min-width: 120px;outline: 0;border: 1px solid silver;font-size: 14px;font-family: FranklinGothic-Book, Verdana, sans-serif;padding: 5px 0px 5px 0px;text-align: left;background-color: #fff;line-height: 20px;box-shadow: 2px 2px 10px #888888;";
    ...
    R.prototype._initialize = function() {
        if (this.enabled) {
            ...
            a += "padding: 5px;";
            a += "font-family: FranklinGothic-Book, Arial, Georgia, serif;";
                ...
                if (f = "", f = this.getToolTipInnerHTML({
                    ...
                    try {
                        this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor :
                            ...
                            0 === this.cornerRadius ? this.cornerRadius + "px" : "5px", this.container.style.borderRadius = this.contentDiv.style.borderRadius, this.contentDiv.style.fontSize = this.fontSize || 0 === this.fontSize ? this.fontSize + "px" : "14px", this.contentDiv.style.color = this.fontColor ? this.fontColor : "#000000", this.contentDiv.style.fontFamily = this.fontFamily ? this.fontFamily : "FranklinGothic-Book, Arial, Georgia, serif;", this.contentDiv.style.fontWeight = this.fontWeight ? this.fontWeight : "normal", this.contentDiv.style.fontStyle = this.fontStyle ? this.fontStyle :
                            t ? "italic" : "normal"
                    } catch (k) {}
